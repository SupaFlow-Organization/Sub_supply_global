    ...
    <section className="py-12 sm:py-16 md:py-20 lg:py-24 bg-white">
      <div className="container mx-auto px-4 sm:px-6">
        <div className="text-center mb-12 sm:mb-16 md:mb-20">
          <FadeIn>
            <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-black text-[#2E4F4A] uppercase italic tracking-tighter mb-3 sm:mb-4">How It Works</h2>
            ...
            {steps.map((step, i) => (
              <FadeIn key={i} delay={i * 100} direction="up">
                <div className="bg-white p-5 sm:p-6 text-center group border border-transparent hover:border-[#F1F5F9] rounded-lg transition-all duration-300 h-full">
                  ...
                  <h3 className="text-sm sm:text-base md:text-lg font-bold text-[#2E4F4A] mb-2 uppercase">{step.title}</h3>
        ...
        <div className="flex flex-col lg:flex-row gap-8 sm:gap-12 lg:gap-16 items-center">
          <div className="lg:w-1/2 w-full">
            <FadeIn direction="right">
              ...
              <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black text-[#2E4F4A] uppercase italic tracking-tighter mb-4 sm:mb-6 md:mb-8 leading-none">
                Precision <br className="hidden sm:block" /> Meet <span className="text-[#8D9B9A]">Velocity.</span>
              </h2>
              <p className="text-[#8D9B9A] text-xs sm:text-sm md:text-base mb-6 sm:mb-8 font-medium max-w-md leading-relaxed">
            ...
            <FadeIn direction="left" delay={200}>
              <div className="aspect-square relative z-10 w-full max-w-lg mx-auto lg:max-w-none">
                <img
                  ...
                  className={`w-full h-full object-cover shadow-2xl grayscale hover:grayscale-0 transition-all duration-700 ${imageLoaded ? 'opacity-100' : 'opacity-0'}`}
                  loading="lazy"
                ...
                {/* Error fallback */}
                {imageError && (
                  <div className="absolute inset-0 bg-gradient-to-br from-[#2E4F4A]/20 to-[#8D9B9A]/20 flex items-center justify-center">
                    <p className="text-[#2E4F4A] text-sm">Image unavailable</p>
                  </div>
                )}
                {/* Decorative Frame */}

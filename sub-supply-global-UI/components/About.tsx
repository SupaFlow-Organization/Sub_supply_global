          ...
          <div className="flex flex-col lg:flex-row gap-8 sm:gap-12 md:gap-16 lg:gap-32 items-center">
                ...
                <div className="relative z-10">
                  ...
                  <div className="relative overflow-hidden aspect-[4/5] shadow-2xl">
                    ...
                    <img
                      ...
                      className={`w-full h-full object-cover scale-105 hover:scale-100 transition-all duration-1000 ${imageLoaded ? 'opacity-100' : 'opacity-0'}`}
                      loading="lazy"
            ...
            <div className="w-full lg:w-1/2">
              <FadeIn direction="left" delay={400}>
                ...
                <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black text-[#2E4F4A] mb-4 sm:mb-6 md:mb-8 leading-[0.9] tracking-tighter font-sans">
                ...
                <p className="text-[#8D9B9A] mb-6 sm:mb-8 md:mb-10 text-xs sm:text-sm md:text-base leading-relaxed font-medium font-sans max-w-lg whitespace-pre-line">
                  {description}
                </p>
              </FadeIn>
            </div>
      ...
      {data?.whatWeDo && data.whatWeDo.length > 0 && (
        <section className="py-10 sm:py-12 md:py-16 bg-[#F8F9FA] relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl relative z-10">
            <FadeIn>
              {/* Title */}
              <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black text-[#2E4F4A] uppercase italic mb-6 sm:mb-8 md:mb-10 font-sans text-center tracking-tighter">
                What We Do
              </h2>
